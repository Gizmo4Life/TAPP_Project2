...
/**
 * Class used to contain the physical properties of a StellarObject (motion, 
 * location, and collisions).
 *
 */
public abstract class Physics{
	 ...
	 * 
	 * @param centroid A point representing the object's centroid; used as a point of reference in construction, a center of mass in "Physics Logic", and likewise in other places.
	 * @param centroid_rot Specifies an initial rotation for the centroid.
	 * @param cimg A collision image, which detects and handles collisions with other Physics instances.
	 * @param gimg A graphical image, responsible for drawing this Physics instance on the screen.
	 */
	public Physics(
	 ...
	 *
	 * @return An angle in the range [0, 2π] equal to the input angle.
	 */
	 ...
	 * @param time_passed_ms The time, in milliseconds, since the last 
	 */
	 ...
	 *
	 * @return The position of this object as a Vector2f
	 */
	public Vector2f getPosition() { 
		return new Vector2f(centroid_pos); 
	}

	/** 
	 * Returns the centroid's current rotation 
	 *
	 * @return The rotation of this object as a float
	 */
	...
	/** 
	 * Returns the angle of the velocity of the object. If there's no velocity, 
	 * a random angle is returned.
	 *
	 * @return A float for the velocity's angle. 
	 */
	 ...
	 *
	 * @return A Vector2f representing the velocity of the object.
	 */
	 ...
	 *
	 * @return The CollisionImage object belonging to this object
	 */
	public CollisionImage getCImg() { 
		return cimg; 
	}
	 ...
	 *
	 * @return The GraphicalImage object belonging to this object
	 */
	public GraphicalImage getGImg() { 
		return gimg; 
	}
	 ...
	 *
	 * @param f The desired friction, between [0, 1] of this object.
	 */
	 ...
	 *
	 * @return The friction of this object as a float
	 */
